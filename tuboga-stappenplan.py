...
# STAPPENPLAN
    # Board maken
        # Maak een achtergrond in Pygame.
        # Maak vierkanten in Pygame.
        # Maak de eerste versie van een board.
        # Leer hoe tekst in Pygame werkt, om locatie namen te geven.
    # 2 spelers maken
        # Maak eerst 1 speler.
        # Copy paste en geef speler 2 een andere kleur.
        # Maak een heel simpel speler model 
    # 2 dobbelstenen maken
        # Er staan genoeg youtube videos over 2 dobbelsten maken
        # Zorg ervoor dat je de dobbelstenen in pygame kan zien
    # Money
        # Een geld systeem maken
        # Geef startgeld
        # Maak een koop systeem
        # Maak een verkoop systeem
        # Als een speler 5000 florins heeft dan wint die en stopt het spel.
    # MP questions
        # Bepaal eerst wat voor soort vragen / famous persons er op het board komen
        # Maak MP vragen met ChatGPT
        # Zorg dat je de vragen in pygame kan zien, miss met buttons om een antwoord te selecteren
    # Components
        # Hoeveel components
        # Een verzamelsysteem voor de components
        # Een inventory om je aantal components te zien?
            # Misschien in de shop laten zien?
    # Special Fields
        # Nog te bepalen met groepsgenoot